...
// node_modules/react-animated-number/build/AnimatedNumber.js
var require_AnimatedNumber = __commonJS({
  "node_modules/react-animated-number/build/AnimatedNumber.js"(exports) {
    "use strict";
    ...
    var AnimatedNumber = function(_Component) {
      _inherits(AnimatedNumber2, _Component);
      function AnimatedNumber2(props) {
        _classCallCheck(this, AnimatedNumber2);
        var _this = _possibleConstructorReturn(this, (AnimatedNumber2.__proto__ || Object.getPrototypeOf(AnimatedNumber2)).call(this, props));
        _this.state = {
          currentValue: props.initialValue
        };
        return _this;
      }
      _createClass(AnimatedNumber2, [{
        ...
        value: function tweenValue(timestamp, start) {
          ...
          var _props = this.props, value = _props.value, duration = _props.duration;
        ...
        value: function render() {
          var _props2 = this.props, formatValue = _props2.formatValue, value = _props2.value, className = _props2.className, frameStyle = _props2.frameStyle, stepPrecision = _props2.stepPrecision;
          var _state = this.state, currentValue = _state.currentValue, fromValue = _state.fromValue;
          ...
          return _react2.default.createElement(this.props.component, _extends({}, filterKnownProps(this.props), { className, style }), formatValue(adjustedValue));
        }
      }]);
      return AnimatedNumber2;
    }(_react.Component);
...
// node_modules/react-animated-number/build/index.js
var require_build = __commonJS({
  "node_modules/react-animated-number/build/index.js"(exports, module) {
    var _AnimatedNumber = require_AnimatedNumber();
...
//# sourceMappingURL=react-animated-number.js.map
